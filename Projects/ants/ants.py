...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        """
        "*** YOUR CODE HERE ***"
        """if self.place != colony.hive:
            if len(self.place.bees) >= 1:
                return self.place.bees[0]
            elif self.place.entrance != None:
                return self.nearest_bee(self.place.entrance)"""
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount=3):
        if self.armor < 1:
            ...
            Insect.reduce_armor(self.place.bees[0], self.damage)
