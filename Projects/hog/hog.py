...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    "*** YOUR CODE HERE ***"
    strat0, strat1 = strategy0, strategy1
    ...
    while score < goal and opponent_score < goal:
        if other(who) == 1:
            take_turn(strat0(score, opponent_score), opponent_score, select_dice(score, opponent_score))
            swine_swap(score, opponent_score)
            who = other(who)
        elif other(who) == 0:
            take_turn(strat1(opponent_score, score), score, select_dice(score, opponent_score))
            swine_swap(score, opponent_score)
            who = other(who)
