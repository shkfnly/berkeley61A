...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    """
    "*** YOUR CODE HERE ***"
    maximum = max((opponent_score // 10 + 1), (opponent_score % 10 + 1))
    if opponent_score / 2 == score + maximum:
        return always_roll(0)(score, opponent_score)
    elif opponent_score * 2 == score + maximum:
...
"""Problem 9 (3 pt). Implement final_strategy, which combines these ideas and any other ideas you have to achieve a win rate of at least 0.59 (for full credit) against the baseline always_roll(5) strategy. (At the very least, try to achieve a win rate above 0.54 for partial credit.) Some ideas:
